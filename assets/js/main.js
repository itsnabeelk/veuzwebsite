...
//   about
  gsap.from(".about-sec .zq_h3_section-title", {
	duration: 1.2,
	scrollTrigger: {
	  trigger: ".about-sec .zq_h3_section-title",
	  toggleActions: "play play none reverse",
	},
	y: 300,
	opacity:"0",
  ...
  gsap.from(".zq_h3_section-text", {
	duration: 1.2,
	scrollTrigger: {
	  trigger: ".zq_h3_section-text",
	  toggleActions: "play play none reverse",
	},
	y: 300,
	opacity:"0",
  ...
  gsap.from(".zq_h3_choose_2-content-bottom", {
	duration: 0.5,
	scrollTrigger: {
	  trigger: ".zq_h3_choose_2-content-bottom",
	  toggleActions: "play play none reverse",
	},
	x: -50,
	opacity:"0",
  ...
  gsap.from(".zq_h3_choose_2-img ", {
	duration: 3,
	scrollTrigger: {
	  trigger: ".zq_h3_choose_2-img",
	  toggleActions: "play play none reverse",
	},
	x: -300,
	opacity:"0",
...
// service
gsap.from(".zq_h3_project-area ", {
	duration: 3,
	scrollTrigger: {
	  trigger: ".zq_h3_project-area",
	  toggleActions: "play play none reverse",
	},
	y: 300,
	opacity:"0",
  ...
  gsap.from(".zq_project-area ", {
	duration: 3,
	scrollTrigger: {
	  trigger: ".zq_project-area",
	  toggleActions: "play play none reverse",
	},
	y: 300,
	opacity:"0",
  ...
  gsap.from(".zq_h4_choose-area ", {
	duration: 3,
	scrollTrigger: {
	  trigger: ".zq_h4_choose-area",
	  toggleActions: "play play none reverse",
	},
	y: 300,
	opacity:"0",
  ...
  gsap.from(".zq_h2_testimonial-area ", {
	duration: 3,
	scrollTrigger: {
	  trigger: ".zq_h2_testimonial-area",
	  toggleActions: "play play none reverse",
	},
	y: 300,
	opacity:"0",
  ...
  gsap.from(".zq_footer-top .zq_footer-widget ", {
	duration: 2,
	opacity:"0",
	stagger: 0.1,
	scrollTrigger: {
	  trigger: ".zq_footer-top .zq_footer-widget",
	  toggleActions: "play play none reverse",
	},
	x: -600,
  });
...
document.addEventListener('DOMContentLoaded', function() {
  const projectItems = document.querySelectorAll('.zq_project-item-custom');
